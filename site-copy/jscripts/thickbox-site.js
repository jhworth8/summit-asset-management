	...
	try {
		if (typeof document.body.style.maxHeight === "undefined") {//if IE 6
			...
			if (document.getElementById("TB_HideSelect") === null) {//iframe to hide select elements in ie6
				jQuery("body").append("<iframe id='TB_HideSelect' src='javascript:false;'></iframe><div id='TB_overlay'></div><div id='TB_window'></div>");
...
/*  var cookie=document.cookie;
	if(cookie.search('changed=yes') != -1){
		document.cookie = 'changed=no; expires=0; path=/';
